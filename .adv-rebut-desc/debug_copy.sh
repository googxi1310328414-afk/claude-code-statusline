...
echo "DEBUG active_cols=[${active_cols[*]}] active_col_count=$active_col_count active_col_width_sum=$active_col_width_sum columns=$columns desc_budget=$desc_budget doc_formula_15=$(( columns - active_col_width_sum - 15 ))" >&2
